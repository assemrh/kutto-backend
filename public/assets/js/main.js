...
=============================================*/
    ...
    if ($(".donate-value").length) {

        $(".donate-value-end").on("keyup", function () {
            $(".donate-value").prop("checked", false);
        });
        $(".donate-value").on("change", function () {
            console.log($(this).val());
            $('.donate-value-end').val($(this).val())
        });
    }
...
=============================================*/
    ...
    $(
        ".product-license li,.shop-details-dimension li,.shop-details-color li"
