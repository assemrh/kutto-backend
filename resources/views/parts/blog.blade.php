    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-9">
                <div class="section-title text-center mb-65">
                    <div class="section-icon"><img src="{{ asset('assets/img/icon/pawprint.png') }}" alt="" ></div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-post-item mb-50">
                    <div class="blog-post-thumb">
                        <a href="/blog-details"><img src="{{ asset('assets/img/blog/blog_post_thumb02.jpg') }}"
                                alt="" ></a>
                        <div class="blog-post-tag">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-post-item mb-50">
                    <div class="blog-post-thumb">
                        <a href="/blog-details"><img src="{{ asset('assets/img/blog/blog_post_thumb03.jpg') }}"
                                alt="" ></a>
                        <div class="blog-post-tag">
